// Imported directly from the pure schema modules (not the "@/schema" barrel)
// so this client-safe file doesn't pull in the barrel's DB-backed persistence
// modules (@/lib/db -> pg) into the browser bundle.
import { validateOryCMSCollectionSchema } from "@/schema/schema.validator";
import type {
