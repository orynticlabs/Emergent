...
export const SectionHead = ({ overline, title, description, dark = true, align = "left" }) => (
  <div className={`max-w-3xl ${align === "center" ? "mx-auto text-center" : ""}`} data-testid="section-head">
    <Reveal>
      <Overline color={dark ? "orange" : "blue"}>{overline}</Overline>
    </Reveal>
    <Reveal delay={0.1}>
