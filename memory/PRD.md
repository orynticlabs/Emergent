...
- Design Gallery (2026-08-22): UIShowcase extended with flippable gallery — browser-framed viewer (category badge, caption overlay), 7 design slides (Analytics Dashboard, AI Console, Enterprise Platform, Marketing Site, Workspace Portal, Infra Monitor, Mobile App), prev/next arrows + counter, thumbnail strip with orange active border, dots. GALLERY IMAGES ARE PLACEHOLDER STOCK — swap with real design shots
- UI & Dashboard showcase (2026-08-22): new landing section after Products — "Premium UI for Websites & Dashboards." with 3 design-practice features (marketing sites, data-dense dashboards, design systems), browser-framed dashboard preview with floating animated "Monthly Revenue +128%" bar-chart card and "Build deployed" pill on mesh bg. Component: components/site/UIShowcase.jsx
- Portfolio page (2026-08-22): /portfolio inspired by apptunix.com/portfolio in OrynticLabs theme — mesh hero with kinetic headline "Digital Products Engineered for Ambitious Businesses.", "Book a Portfolio Walkthrough" CTA, stat card row (08 practices / 03 products / 11 industries + image cards), working category filters (All/AI Solutions/Web Platforms/Mobile Apps/Enterprise Software) + live search, 8 project cards with category/industry chips, tech tags, "Discuss a similar project" links. PROJECT ENTRIES ARE PLACEHOLDER CONCEPTS — replace with real client work. Added to navbar + footer sitemap
- Engagement models section (2026-08-22): "Three Ways to Start Your Digital Transformation." — 01 Architecture Review, 02 Dedicated Engineering Pod, 03 Full Digital Transformation (Most Recommended badge), each with description, 3 checkmarked points with underlines, "Best for" line; mesh bg; placed between FAQ and CTA. Component: components/site/EngagementModels.jsx
- Automobile spotlight (2026-08-22): detailed industry section on landing page (after Industries tabs) — "Software for the Future of Mobility." with 4 capability cards (Fleet Management, Vehicle Telematics, Dealer & Distributor Systems, EV & Charging Infrastructure) each with detailed explanation, sticky image + "What we deliver" checklist, link to /industries. Component: components/site/AutomobileSection.jsx
