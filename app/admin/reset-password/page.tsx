...
const signals = [
  ...
  },
  {
    ...
    body: "Resetting your password signs you out everywhere else, in case a device was compromised.",
  },
  {
    icon: Shield,
    title: "One-time link",
    body: "This reset link can only be used once and expires after 1 hour.",
  },
];
        ...
        <div className="relative flex flex-1 flex-col justify-between px-10 py-10">
          ...
          <div className="max-w-[500px]">
            ...
            <p className="mt-4 text-[14px] leading-relaxed text-muted-foreground">
              Set a new password below to regain access to your OryCMS account.
            </p>
          ...
          {done ? (
            <>
              <div className="flex items-start justify-between gap-3">
                <div>
                  <h2 className="text-[22px] font-semibold tracking-tight">Password updated</h2>
            ...
            <>
              <div className="flex items-start justify-between gap-3">
                <div>
                  ...
                  <p className="mt-1 text-[13px] text-muted-foreground">Choose a new password below.</p>
                </div>
                <div className="mt-0.5 grid h-10 w-10 shrink-0 place-items-center rounded-xl bg-foreground text-background">
                  <KeyRound className="h-4 w-4" />
                </div>
