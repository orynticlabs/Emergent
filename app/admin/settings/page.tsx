...
export default function SettingsPage() {
  ...
  return (
    <AppShell section="Settings">
            ...
            <Card className="p-5">
              ...
              <div className="mt-5">
                <SettingRow
                  ...
                  description="Add an authenticator app as a second factor when signing in to this admin account."
                  control={
                    <div className="flex items-center gap-3">
                      ...
                      {mfaEnabled ? (
                        ...
                        <Button onClick={() => setMfaSetupOpen(true)}>Enable MFA</Button>
                      )}
                    </div>
                  }
                />
      ...
      <OryCMSMfaSetupDialog open={mfaSetupOpen} onOpenChange={setMfaSetupOpen} />
      <OryCMSMfaDisableDialog open={mfaDisableOpen} onOpenChange={setMfaDisableOpen} />
    </AppShell>
  );
}
