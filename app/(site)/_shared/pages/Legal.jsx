...
const CONTENT = {
  ...
  "terms-conditions": {
    ...
    sections: [
      { title: "Use of this website", text: "Content on this website is provided for general information about OrynticLabs Private Limited and its services. It does not constitute a binding offer, proposal, or professional advice." },
      { title: "Engagements", text: "All project work is governed by a documented scope of work and a separately executed agreement between OrynticLabs and the client. Website content does not override those agreements." },
      { title: "Intellectual property", text: "All content, branding, and product names on this site — including OryAI, OryCMS, and PerformX — are the property of OrynticLabs Private Limited unless stated otherwise." },
      { title: "Limitation of liability", text: "OrynticLabs is not liable for indirect or consequential damages arising from use of this website or reliance on its content." },
  ...
  "terms-of-service": {
    ...
    accentIndex: 1,
    description: "Service-level terms for OrynticLabs platforms and products, including OryAI, OryCMS, and PerformX.",
    sections: [
      { title: "Service provision", text: "Access to OrynticLabs products and platforms is provided under the commercial terms agreed in each engagement — SaaS subscription, PaaS licensing, or custom project agreements." },
